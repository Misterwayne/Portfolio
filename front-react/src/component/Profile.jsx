        ...
        <div className="container-fluid bg-dark text-light">
            <div className="row align-items-start">
                ...
                <div className="col text-wrap">
                    ...
                    <p>Je suis depuis de 2019 a l'ecole 42 (96 Boulevard Bessieres, 75017 PARIS) pour preparez un titre RNCP (Répertoire national de la certification professionnelle) "Expert en Architecture Informatique".</p>
                </div>
            </div>
        </div>
    );
